...
_GOR             		EQU	RAM_START + 026h
_GUN             		EQU	RAM_START + 027h
_MEM             		EQU	RAM_START + 028h
_ONLAR           		EQU	RAM_START + 029h
PB01            		EQU	RAM_START + 02Ah
_SAAT            		EQU	RAM_START + 02Bh
_SAYAC           		EQU	RAM_START + 02Ch
_SAYI            		EQU	RAM_START + 02Dh
_SIGN            		EQU	RAM_START + 02Eh
_SN              		EQU	RAM_START + 02Fh
_TEMP            		EQU	RAM_START + 030h
_Y               		EQU	RAM_START + 031h
_YIL             		EQU	RAM_START + 032h
_PORTL           		EQU	 PORTB
_PORTH           		EQU	 PORTA
_TRISL           		EQU	 TRISB
_TRISH           		EQU	 TRISA
...
_Deg             		EQU	000DFh
 ...
 DEVICE pic16F628, INTRC_OSC_NOCLKOUT  
	...
	LABEL?L	_BASLA	
	ICALL?L	L00001
	CMPNE?BCL	_Y, 00Bh, L00003
	MOVE?CB	000h, _Y
	LABEL?L	L00003	
	ICALL?L	L00001
	CMPLE?BCL	_Y, 005h, L00005
	GOSUB?L	_EKRAN1
	LABEL?L	L00005	
	ICALL?L	L00001
	CMPGE?BCL	_Y, 006h, L00007
	GOSUB?L	_EKRAN0
	LABEL?L	L00007	
	...
	LOW?T	_PORTB_2
	ICALL?L	L00001
	CMPNE?TCL	_SIGN_BITI, _NEGAT_ISI, L00011
	MOVE?CB	040h, _SAYI
	LABEL?L	L00011	
	ICALL?L	L00001
	SHIFTDATA?T	_DTA
	...
	ICALL?L	L00001
	CMPNE?TCL	_YUKARI, 000h, L00015
	ICALL?L	L00001
	ADD?BCB	_SAAT, 001h, _SAAT
	ICALL?L	L00001
	CMPNE?BCL	_SAAT, 018h, L00017
	MOVE?CB	000h, _SAAT
	LABEL?L	L00017	
	ICALL?L	L00001
	LABEL?L	L00015	
	ICALL?L	L00001
	CMPNE?TCL	_ASAGI, 000h, L00019
	ICALL?L	L00001
	SUB?BCB	_SAAT, 001h, _SAAT
	ICALL?L	L00001
	CMPNE?BCL	_SAAT, 0FFh, L00021
	MOVE?CB	017h, _SAAT
	LABEL?L	L00021	
	ICALL?L	L00001
	LABEL?L	L00019	
	...
	ICALL?L	L00001
	CMPNE?TCL	_YUKARI, 000h, L00025
	ICALL?L	L00001
	ADD?BCB	_DAK, 001h, _DAK
	ICALL?L	L00001
	CMPNE?BCL	_DAK, 03Ch, L00027
	MOVE?CB	000h, _DAK
	LABEL?L	L00027	
	ICALL?L	L00001
	LABEL?L	L00025	
	ICALL?L	L00001
	CMPNE?TCL	_ASAGI, 000h, L00029
	ICALL?L	L00001
	SUB?BCB	_DAK, 001h, _DAK
	ICALL?L	L00001
	CMPNE?BCL	_DAK, 0FFh, L00031
	MOVE?CB	03Bh, _DAK
	LABEL?L	L00031	
	ICALL?L	L00001
	LABEL?L	L00029	
	...
	MOVE?CW	000h, _X
	LABEL?L	L00035	
	CMPGT?WCL	_X, 00708h, L00036
	ICALL?L	L00001
	PAUSEUS?C	064h
	ICALL?L	L00001
	NEXT?WCL	_X, 001h, L00035
	LABEL?L	L00036	
	ICALL?L	L00001
	RETURN?	
	...
	MOVE?CB	02Bh, _SIGN
	ICALL?L	L00001
	CMPNE?TCL	_SIGN_BITI, _NEGAT_ISI, L00039
	ICALL?L	L00001
	MOVE?CB	02Dh, _SIGN
	ICALL?L	L00001
	...
	CMPNE?BCL	_SAYAC, 03Dh, L00041
	MOVE?CB	000h, _SAYAC
	ADD?BCB	_Y, 001h, _Y
	GOSUB?L	_ZAMAN_OKU
	CMPGE?BCL	_Y, 005h, L00043
	HIGH?T	_PORTA_3
	LABEL?L	L00043	
	LABEL?L	L00041	
